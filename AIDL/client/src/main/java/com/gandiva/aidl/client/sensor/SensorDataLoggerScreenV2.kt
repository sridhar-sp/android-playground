...
@Composable
fun SensorDataLoggerScreenV2(viewModel: SensorDataLoggerViewModelV2 = hiltViewModel()) {
    Column(Modifier.fillMaxSize().padding(MaterialTheme.appDimens.mediumContentPadding)) {
        Text(
            text = "SensorDataLoggerScreen Using Service Connector Approach",
